...
def load_and_split_document(uploaded_file):
    ...
    # Debug: Print out the first few documents to check the format
    print(documents[:3])  # Print the first 3 documents to check their structure
...
if uploaded_file is not None:
    ...
    # Debug: Print out the structure of the documents
    print(documents[:3])  # Check the first few chunks
